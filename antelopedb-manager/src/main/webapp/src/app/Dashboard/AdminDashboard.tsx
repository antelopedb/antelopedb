...
// https://patternfly-react.surge.sh/icons/
...
const AdminDashboard: React.FunctionComponent = () => {
  ...
  */
  ...
  return (
    ...
    /*
      we don't have any clusters, so this is the first boot
     */
    : !isClusters?
      <EmptyState variant={EmptyStateVariant.full}>
            <ClusterIcon size={"xl"}/>
            <Title headingLevel="h5" size="lg">
              No AntelopeDB Clusters created, click to create one
            </Title>
            <ClusterWizard handleData={onHandleData} handleState={onIsClusters} buttonLabel='Create New Cluster'/>
      </EmptyState>
    /*
      Regular operation, we have clusters defined and we show the real dashboard.
     */
    :
      <PageSection>
        <Title headingLevel="h1" size="lg">Admin Dashboard Page Title!</Title>
      </PageSection>
  )
}
